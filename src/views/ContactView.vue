                    ...
                    <div class="text-center">
                        ...
                        <!-- <h1 class="mt-2 font-light text-[20px] text-white">or
                            <button @click="modalOpen = true"
                                class="px-2 mt-5 text-black font-bold bg-red-300 rounded-md hover:bg-red-400 focus:outline-none">
                                Ask
                            </button>
                            me!
                        </h1> -->
                        ...
                        <div v-if="modalOpen" class="fixed inset-0 z-50 flex items-center justify-center">
                            <div class="bg-white p-32 rounded-lg shadow-lg text-black">
                                ...
                                <button @click="modalOpen = false"
                                    class="mt-4 px-2 bg-red-300 text-black rounded-md hover:bg-red-400 focus:outline-none">
